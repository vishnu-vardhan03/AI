      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-2 max-w-sm">AI engineering studio building intelligence for ambitious teams.</p>
          </div>
          <div className="flex gap-3">
            {[Twitter, Linkedin, Github, Instagram].map((Icon, i) => (
              <a key={i} href="#" className="size-10 rounded-full glass grid place-items-center hover:bg-white hover:text-black transition-colors">
