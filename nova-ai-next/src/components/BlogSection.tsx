...
export function BlogSection() {
  ...
  return (
    <>
      <section id="blog" className="bg-transparent text-black py-24 px-6 md:px-12 lg:px-20 w-full overflow-hidden border-t border-zinc-200">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-16">
            <div className="max-w-2xl">
              {/* Top Chip */}
              <span className="text-[10px] tracking-[0.25em] font-black text-[#0052d4] uppercase border border-zinc-350 rounded-md px-4 py-1.5 bg-white/40 block mb-6 w-fit">
                Insights & Updates
              </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              <div className="mt-5 flex justify-between items-start gap-4">
                <h4 className="font-black text-lg md:text-xl lg:text-2xl uppercase tracking-tight text-black leading-tight group-hover:text-zinc-700 transition-colors max-w-[75%]">
                  {BLOGS[0].title}
                </h4>
            ...
            >
              ...
              <div className="mt-5 flex justify-between items-start gap-4">
                <h4 className="font-black text-lg md:text-xl lg:text-2xl uppercase tracking-tight text-black leading-tight group-hover:text-zinc-700 transition-colors max-w-[70%]">
                  {BLOGS[1].title}
                </h4>
                <span className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider whitespace-nowrap pt-1">
                  {BLOGS[1].date}
