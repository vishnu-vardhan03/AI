...
import consultingEcosystemImg from "@/assets/consulting_ecosystem_new.png";
      ...
      >
        ...
        <div
          className={`absolute inset-0 w-full h-full p-6 rounded-2xl border flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 ${
            index === 0
              ? "bg-[#cbebff] border-blue-300/80 text-black"
              : index === 1
        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full">
            ...
            {service.image && (
              <div className={
                index === 0
                  ? "absolute bottom-0 left-0 right-0 h-[220px] rounded-b-2xl overflow-hidden bg-transparent p-0"
                  : "absolute bottom-0 left-0 right-0 h-[210px] rounded-b-2xl overflow-hidden flex items-center justify-center p-2 bg-transparent"
              }>
                <img
                  ...
                  className={
                    index === 0
                      ? "w-full h-full object-fill invert mix-blend-multiply opacity-90"
                      : "w-full h-full object-contain scale-95 invert opacity-90"
                  }
                />
              </div>
            )}
          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="my-3">
              <p className={`text-[9px] uppercase tracking-widest mb-2 font-bold ${
                index === 0 ? "text-blue-900/60" : index === 1 ? "text-teal-950/60" : "text-purple-950/60"
              }`}>
                KEY FOCUS AREAS
              </p>
                ...
                {service.includes.map((inc) => (
                  <span
                    ...
                    className={`text-[10px] px-2.5 py-1 font-semibold rounded border ${
                      index === 0
                        ? "bg-blue-950/5 border-blue-950/10 text-blue-950"
                        : index === 1
            ...
            <div className={`mt-auto pt-2 border-t ${
              index === 0 ? "border-blue-950/10" : index === 1 ? "border-teal-950/10" : "border-purple-950/10"
            }`}>
              <a
                href="#contact"
                className={`inline-flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider transition-all px-4 py-2 rounded border ${
                  index === 0
                    ? "text-blue-950 border-blue-950/20 hover:bg-blue-950 hover:text-white"
                    : index === 1
