...
function SideCard({
  ...
  return (
    <motion.div
      style={{ x, y, rotate, scale, opacity, zIndex: order === 1 ? 15 : 12 }}
    ...
    >
      <Image src={robotImg} alt="" className="w-full h-full object-cover" />
    </motion.div>
  );
}
    ...
    <section ref={ref} className="relative h-[280vh]">
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center px-6">
        ...
        <div className="relative w-full max-w-7xl h-[78vh] flex items-center justify-center">
          <SideCard progress={scrollYProgress} side="left" order={2} />
          <SideCard progress={scrollYProgress} side="right" order={2} />
          <SideCard progress={scrollYProgress} side="left" order={1} />
          <SideCard progress={scrollYProgress} side="right" order={1} />
