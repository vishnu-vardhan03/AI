...
const cases = [
  ...
  },
  {
    ...
    grad: "from-amber-500/20 to-rose-500/20",
  },
  {
    tag: "Healthcare",
    title: "Clinical copilot for triage",
    metric: "4× faster intake",
    grad: "from-emerald-500/20 to-cyan-500/20",
  },
  {
    tag: "Logistics",
    title: "Autonomous routing platform",
    metric: "−21% fuel cost",
    grad: "from-zinc-400/20 to-zinc-700/20",
  },
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {cases.map((c) => (
            ...
            >
              <div
                className={`aspect-[16/10] bg-gradient-to-br ${c.grad} relative overflow-hidden`}
              >
                <motion.div
                ...
                />
                <div className="absolute top-4 left-4 text-xs px-3 py-1 rounded-full bg-black/40 backdrop-blur border border-white/10">
                  {c.tag}
                </div>
